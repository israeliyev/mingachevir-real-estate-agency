...
export declare class BaseChartDirective implements OnDestroy, OnChanges, OnInit, Colors {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<BaseChartDirective, "canvas[mdbChart]", ["mdb-base-chart"], { "data": "data"; "datasets": "datasets"; "labels": "labels"; "options": "options"; "chartType": "chartType"; "colors": "colors"; "legend": "legend"; }, { "chartClick": "chartClick"; "chartHover": "chartHover"; }, never, never, false, never>;
}
